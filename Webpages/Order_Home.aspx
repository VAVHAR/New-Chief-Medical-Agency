<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order_Home.aspx.cs" Inherits="New_Chief_Medical_Agency.Webpages.Order_Home" %>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="p-2" style="background-color: #e3f2fd;">
                    <div class="d-flex flex-row justify-content-center" style="font-size:15px;">
                        <div class="p-2">
                            <asp:Button ID="btnproduct" runat="server" CssClass="btn btn-light"  Width="80px" Height="30px" Text="Order" BackColor="#E3F2FD" BorderColor="#E3F2FD" BorderStyle="None" />
                        </div>
                        <div class="p-2">
                            <asp:Button ID="btnstocks" runat="server" CssClass="btn btn-light"  Width="80px" Height="30px" Text="Supplier" BackColor="#E3F2FD" BorderColor="#E3F2FD" BorderStyle="None" />
                        </div>
                        <div class="p-2">
                            <asp:Button ID="btnorders" runat="server" CssClass="btn btn-light"  Width="120px" Height="30px" Text="Order Placed" BackColor="#E3F2FD" BorderColor="#E3F2FD" BorderStyle="None" />
                        </div>
                    </div>
                </div>
                <div class="p-2">
                    ...
                    <div style="font-size: 16px; margin-top: -15px;">
                        ...
                        <div style="text-align:center;">
                           <asp:button ID="btnsaveproduct" runat="server" class="btn btn-primary" Text="Save Product" Width="100px" Height="30px" Font-Size="Small" />
                        </div>
                    </div>
                </div>
            </div>
